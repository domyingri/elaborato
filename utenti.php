...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="utenti.php" class="logo">Area <span class="lite">Utenti</span></a>
      <!--logo end-->
    ...
    <section id="main-content">
      ...
      <div class="text-center">
        <div class="credits">
          ...
          -->
          <br>
          Designed by <a href="https://www.facebook.com/luigi.delucia.779">DELUXEDESIGN</a>
        </div>
      </div>
    </section>
    <!--main content end-->
    ...
    <script>
      ...
      <script src="js/jquery-confirm.js"></script>
          ...
          function Prenotazione() {
                  $.dialog({
                  title: '<h4 style="color:brown">Prenota il campo che desideri.!</h4>',
                  columnClass: 'large', type: 'blue', animation: 'zoom', closeIcon: true,
                    content: function() {
                    var self = this; self.setContent("");
                    return $.ajax({
                            url: 'Prenota.php', method: 'get',
